...
### 💻 recent projects
- **[leaderboardgo](https://github.com/tahzeer/leaderboardgo)** — A scorekeeping service built in golang, exposing HTTP, WebSocket, and gRPC APIs, enabling low-latency real-time score ingestion and leaderboard streaming. Learned a bit about observability; Prometheus, OpenTelemetry traces, and pprof profiling, accelerating bottleneck detection across high-RPS traffic. Benchmarked with race tests and 80/20 read-write load generation maintaining 200-RPS throughput consistency.
